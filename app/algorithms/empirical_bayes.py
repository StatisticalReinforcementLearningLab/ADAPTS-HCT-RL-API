...
from app.models import EmpiricalBayesSnapshot, Group, StandardizationBaseline
...
class ThreeAgentEmpiricalBayesAlgorithm(RLAlgorithm):
    ...
    def _save_snapshot(
        ...
        with self.app.app_context():
            snapshot = EmpiricalBayesSnapshot(
    ...
    def _load_latest_snapshot(
        ...
        if self.app is None:
            return None
        with self.app.app_context():
            query = EmpiricalBayesSnapshot.query.filter_by(
                snapshot_type=snapshot_type,
                decision_type=decision_type,
                group_id=group_id,
